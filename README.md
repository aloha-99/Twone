...
* 어려웠던 점 <br/>
📌 이메일 인증을 통한 회원가입 방법과 관련한 기능 구현에 어려움을 겪었다. <br/>
✔  spring-boot-starter-mail이라는 라이브러리에 관해 학습하여 Configuration으로 따로 만들어 사용하여 기능을 구현하였으며, 인증 실패 시의 프로세스까지 고려하여 사용자의 데이터를 저장하고 관리하였다.  <br/><br/>
